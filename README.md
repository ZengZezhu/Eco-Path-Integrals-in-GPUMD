...
<p align="center">
  <img src="./eco-toc.png" width="700" alt="Eco-PIMD concept figure">
</p>
...
This is a wavenumber cutoff, not an angular frequency. It is used by Eco to optimise the internal mode frequencies of the ring polymer. It should be set to the highest phonon wavenumber in your system (e.g., 3500 cm<sup>-1</sup> ~ 100 THz for MOF-5). 
